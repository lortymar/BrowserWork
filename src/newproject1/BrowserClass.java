...
public class BrowserClass {
	public static void main(String args[]) throws InterruptedException
	{
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Ìàðêåò")));
			WebElement market = driver.findElement(By.linkText("Ìàðêåò"));
			...
			try {
     	    ...
     	    //Îæèäàíèå 10 ñåêóíä ïåðåä çàêðûòèåì áðàóçåðà
     	    Thread.sleep(20000);
     	   try {
     	...
     	for (String tab: driver.getWindowHandles())
     	{
     	 ...
     	 System.out.println("Îöåíêà: " + link.getText());
